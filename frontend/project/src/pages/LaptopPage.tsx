...
const LaptopPage: React.FC = () => {
  ...
  // Filter for laptop/desktop devices only
  const laptopDevices = useMemo(() => {
    return devices.filter(device => 
      ['Laptop', 'Desktop'].includes(device.type)
    );
  }, [devices]);

  const filteredDevices = useMemo(() => {
    const filtered = laptopDevices.filter(device => {
      const matchesSearch = 
  ...
  }, [laptopDevices, searchTerm, statusFilter, typeFilter]);
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Laptop & Desktop Management</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Manage and track all your laptop and desktop computers</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-6 shadow-sm">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search laptops and desktops..."
              value={searchTerm}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Add Laptop/Desktop</h2>
              <button
